...
async function pool(){
    const url = 'https://airbnb13.p.rapidapi.com/search-location?location=swimming%20pool&checkin=2023-09-16&checkout=2023-09-17&adults=1&children=0&infants=0&pets=0&page=1&currency=USD';
    const options = {
        method: 'GET',
        headers: {
